...
export default function Students() {
  ...
  const [editandoAluno, setEditandoAluno] = useState(null); // aluno sendo editado
        ...
        {showForm && (
          <div style={{
            ...
            <h3 style={{
              ...
              color: editandoAluno ? "#BA7517" : "#2B9EC3"
            }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
              ...
              <div style={{ display: "flex", gap: 12 }}>
                <button
                  onClick={() => { setShowForm(false); setEditandoAluno(null); setError(null); }}
